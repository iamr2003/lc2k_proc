...
VL_INLINE_OPT void Vmem___024root___ico_sequent__TOP__0(Vmem___024root* vlSelf) {
    ...
    if (vlSelfRef.write_enable) {
        vlSelfRef.mem__DOT____Vlvbound_h4de963a5__0 
            = vlSelfRef.write_data;
        if ((0x10000U >= (0x1ffffU & vlSelfRef.addr))) {
            vlSelfRef.mem__DOT__data[(0x1ffffU & vlSelfRef.addr)] 
                = vlSelfRef.mem__DOT____Vlvbound_h4de963a5__0;
        }
    }
    vlSelfRef.read_data = ((0x10000U >= (0x1ffffU & vlSelfRef.addr))
                            ? vlSelfRef.mem__DOT__data
                           [(0x1ffffU & vlSelfRef.addr)]
                            : 0U);
}

void Vmem___024root___eval_triggers__ico(Vmem___024root* vlSelf);

bool Vmem___024root___eval_phase__ico(Vmem___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem___024root___eval_phase__ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vmem___024root___eval_phase__act(Vmem___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem___024root___eval_phase__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vmem___024root___eval_phase__nba(Vmem___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmem___024root___eval_phase__nba\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#endif
            VL_FATAL_MT("mem.v", 1, "", "Input combinational region did not converge.");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        __VicoContinue = 0U;
        if (Vmem___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
...
#endif
            VL_FATAL_MT("mem.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("mem.v", 1, "", "Active region did not converge.");
            }
            vlSelfRef.__VactIterCount = ((IData)(1U) 
                                         + vlSelfRef.__VactIterCount);
            vlSelfRef.__VactContinue = 0U;
            if (Vmem___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vmem___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
