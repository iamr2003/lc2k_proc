...
#endif
            VL_FATAL_MT("decoder.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vdecoder___024root___ctor_var_reset(Vdecoder___024root* vlSelf) {
    ...
    vlSelf->opcode = VL_RAND_RESET_I(3);
    vlSelf->regA = VL_RAND_RESET_I(3);
    vlSelf->regB = VL_RAND_RESET_I(3);
    vlSelf->destReg = VL_RAND_RESET_I(3);
    vlSelf->offsetField = VL_RAND_RESET_I(16);
}
